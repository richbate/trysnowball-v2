...
const Coach = () => {
  ...
  const { debts, paymentHistory, projections, totalDebt, totalMinPayments, extraPayment } = useDebts();
  ...
  // Loading management
  useEffect(() => {
    setLoading(userLoading || entitlementLoading);
  }, [userLoading, entitlementLoading]);
...
${report.active_debts.map(debt => 
  `${debt.snowball_order}. ${debt.name}: £${debt.balance.toLocaleString()} (${debt.interest_rate}% APR, £${debt.minimum_payment}/month)`
).join('\n')}
    ...
    return (
      <div className={`min-h-screen ${colors.background} px-6 py-12`}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h1 className="text-4xl font-bold mb-4">AI Debt Coach</h1>
          <p className="text-xl mb-8 text-gray-600">
            Get smart coaching with AI that understands UK debt
          </p>
      ...
      <div className="max-w-6xl mx-auto py-8 px-4">
        ...
        <div className="space-y-8">
          ...
          <div className={`${colors.surface} rounded-lg p-6 border ${colors.border} text-center`}>
            ...
            <h2 className="text-2xl font-semibold mb-4">🐈‍⬛ Meet Yuki — your AI debt coach</h2>
            <p className={`${colors.text.secondary} mb-4 max-w-2xl mx-auto`}>
              Get personalized coaching based on your debt situation. Ask questions, get strategies, and stay motivated on your path to debt freedom.
            </p>
          </div>
