...
import { loadUserProfile } from './userProfile.ts';
...
export function track(event, props = {}) {
  try {
    ...
    if (demo_mode && GUARDED_EVENTS.has(event)) {
      console.log(`🛡️ Blocked demo funnel event: ${event}`);
      return;
    }
...
export function identify(userId, traits = {}) {
  try {
    ...
    if (demo_mode) {
      ...
      console.log('🛡️ Blocked user identification in demo mode');
      return;
    }
...
export function setUserProperties(properties = {}) {
  try {
    ...
    if (demo_mode) {
      ...
      console.log('🛡️ Blocked user properties in demo mode');
      return;
    }
