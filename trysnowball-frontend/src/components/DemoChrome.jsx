/**
 * DemoChrome - Global demo mode banner + watermark
 * Single source of truth for demo mode UI elements
 */

import React from 'react';
import { getDemoMeta, useDemoMode } from '../providers/DemoModeProvider';
